...
class CMS_Element extends Standard {
	...
	function load() {
		...
		$this->value = array(); // Vi nulstiller først alle oplysninger, hvis de tidligere har været loadet.
	...
	/**
	 *
	 * Her må ikke bruges safeToDb på hele arrayet, for ellers kommer vi til at behandle
	...
	function save($var) {
		...
		if ($this->id == 0) {
			...
			// sæt position for nye elementer
		...
		// HACK det er naturligvis et hack, men vi må kunne finde ud af hvad der er galt
  ...
  /**
   *
   * Funktionen skal kun deaktivere, så intet nogensinde bliver slettet fra databasen.
	*/
	function delete(){
