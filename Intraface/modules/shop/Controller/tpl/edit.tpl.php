...
<form action="<?php e(url()); ?>" method="post">
    <fieldset>
        ...
        <input type="text" name="name" id="name" value="<?php e($data['name']); ?>" />

        <br />

        <label for="identifier"><?php e(t('Identifier')); ?></label>
        <input type="text" name="identifier" id="identifier" value="<?php e($data['identifier']); ?>" />
    ...
    <fieldset>
        ...
        <textarea name="confirmation" cols="80" rows="10"><?php e($data['confirmation']); ?></textarea>
        </div>
    </fieldset>
    ...
    <fieldset>
        ...
        <textarea name="receipt" cols="80" rows="10"><?php e($data['receipt']); ?></textarea>
        </div>
    </fieldset>
    ...
    <fieldset>
        ...
        <textarea name="description" cols="80" rows="10"><?php e($data['description']); ?></textarea>
        </div>
    </fieldset>
