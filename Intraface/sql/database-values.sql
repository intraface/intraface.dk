...
INSERT INTO `core_translation_langs` (`id`, `name`, `meta`, `error_text`, `encoding`) VALUES ('dk', 'dansk', 'some meta info', 'ikke tilgængelig', 'iso-8859-1'), ('uk', 'english', 'some meta info', 'not available', 'iso-8859-1');
