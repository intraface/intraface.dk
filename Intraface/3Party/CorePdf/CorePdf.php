...
*/
function CorePdf ($pageSize=array(0,0,612,792)){
...
function addJpegFromFile($img,$x,$y,$w=0,$h=0){
  ...
  if ($h==0){
	...
	HACK HACK HER AF SUNE
	AF en eller anden grund, så kunne fread ikke læse filen rigtig. file_get_contents kunne i stedet godt. 
	Her er det udskiftet, men hvad mon det ellers har af konsekvenser????
