...
class Intraface_Install {
    ...
    function createDatabaseSchema() {
        $sql_structure = file_get_contents(dirname(__FILE__) . '/sql/database-structure.sql');
        ...
        $sql_structure = file_get_contents(dirname(__FILE__) . '/sql/database-update.sql');
        $sql_arr = explode(';',$sql_structure);
    ...
    function createStartingValues() {
        $sql_values = file_get_contents(dirname(__FILE__) . '/sql/database-values.sql');
