...
class UploadHandler extends Standard {
	...
	function UploadHandler(&$file_handler) {
	...
	/**
	 * Upload fil
	 *@param input: er navnt på inputfeltet eller et http_upload_file object
	 *@param upload_type: har enten værdien 'save' (gemmer filen i filehandler og returnerer id), eller 'temporary' (gemmer i filehandler, men med temporary sat) eller 'do_not_save' (flytter filen til tempdir og returnerer fil-sti)
	 */
