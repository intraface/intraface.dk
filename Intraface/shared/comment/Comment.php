...
class Comment extends Standard {
	...
	function Comment(& $object, $id = 0) {
		if (!is_object($object)) {
			trigger_error('Comment::Comment kræver et object', FATAL);
		}
...
//		$db->query(
		// beskeder skal først fremkomme for alle andre end kontakten selv, når der er gået ti minutter
		// man har altså ti minutter til at ændre og slette.
		return $messages;
	}
}
