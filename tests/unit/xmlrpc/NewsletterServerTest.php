...
class FakeNewsletterServerKernel {
    public $intranet;
    public $setting;
}

class FakeNewsletterServerSetting {
    function get() {
        return '';
    }
}
class FakeNewsletterServerIntranet {
    private $id;
...
class NewsletterServerTest extends PHPUnit_Framework_TestCase {
    ...
    function __construct() {
        ...
        $this->kernel = new FakeNewsletterServerKernel;
        $this->kernel->intranet = new FakeNewsletterServerIntranet($intranet_id);
        $this->kernel->setting = new FakeNewsletterServerSetting;
    }
