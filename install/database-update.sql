...
ALTER TABLE `currency` ADD `deleted_at` TIMESTAMP NOT NULL DEFAULT 0;
UPDATE `currency` SET deleted_at = NOW() WHERE deleted = 1;
ALTER TABLE `currency` CHANGE `deleted` `_old_deleted` INT( 1 ) NOT NULL ;

ALTER TABLE `product_attribute` ADD `deleted_at` TIMESTAMP NOT NULL DEFAULT 0;
...
ALTER TABLE `product_attribute_group` ADD `deleted_at` TIMESTAMP NOT NULL DEFAULT 0;
...
ALTER TABLE `product_variation` ADD `deleted_at` TIMESTAMP NOT NULL DEFAULT 0;
