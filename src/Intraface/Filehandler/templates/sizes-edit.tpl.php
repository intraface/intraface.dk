...
<form action="<?php e(url('./')); ?>" method="post">
    ...
    <fieldset>
        ...
        <div class="formrow">
            ...
            <input type="text" name="max_width" id="max_width" value="<?php if (isset($value['max_width'])) {
                echo e($value['max_width']);
} ?>" />
        </div>

        <div class="formrow">
            <label for="max_height"><?php e(t('Maximum height')); ?>:</label>
            <input type="text" name="max_height" id="max_height" value="<?php if (isset($value['max_height'])) {
                echo e($value['max_height']);
} ?>" />
        </div>
        ...
        <div class="formrow">
            ...
            <select name="resize_type" id="resize_type">
                <?php foreach ($instance_manager->getResizeTypes() as $resize_type) : ?>
                    <option value="<?php e($resize_type); ?>" <?php if (isset($value['resize_type']) && $value['resize_type'] == $resize_type) {
                        e('selected="selected"');
} ?> ><?php e(t($resize_type)); ?></option>
                <?php endforeach; ?>
            </select>
        </div>
