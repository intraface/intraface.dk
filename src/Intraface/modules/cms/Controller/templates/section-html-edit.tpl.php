...
?>
    ...
    <fieldset>
        ...
        <div class="formrow">
            ...
            <select name="elm_properties">
                ...
                <option value="<?php e($key); ?>"<?php if (!empty($value['elm_properties']) and $value['elm_properties'] == $key) {
                    echo ' selected="selected"';
} ?>><?php e(t($property)); ?></option>
                <?php endforeach; ?>
            </select>
        </div>
        ...
        <div class="formrow">
            ...
            <select name="elm_adjust">
                ...
                <option value="<?php e($key); ?>"<?php if (!empty($value['elm_adjust']) and $value['elm_adjust'] == $key) {
                    echo ' selected="selected"';
} ?>><?php e(t($alignment, 'cms')); ?></option>
                <?php endforeach; ?>
            </select>
        </div>
        ...
        <div class="formrow">
            ...
            <input name="elm_width" id="elm-width" type="text" value="<?php if (!empty($value['elm_width'])) {
                e($value['elm_width']);
} ?>" size="3" maxlength="10" /> <?php e(t('use either %, em or px')); ?>
        </div>


        <div class="radiorow">
            <p>
                <input name="elm_box" id="elm-box" value="box" type="checkbox"<?php if (!empty($value['elm_box']) and $value['elm_box'] == 'box') {
                    echo ' checked="checked"';
} ?> /> <label for="elm-box"><?php e(t('show element in a box')); ?></label>
            </p>
        </div>
    ...
    <fieldset>
        ...
        <div class="formrow">
            ...
            <input name="date_publish" id="dateFieldPublish" type="text" value="<?php if (!empty($value['date_publish'])) {
        ...
        <div class="formrow">
            ...
            <input name="date_expire" id="dateFieldExpire" type="text" value="<?php if (!empty($value['date_expire'])) {
                e($value['date_expire']);
