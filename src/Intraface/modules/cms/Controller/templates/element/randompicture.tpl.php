...
<fieldset>
    <div class="formrow">
        ...
        <select name="size">
            <option value="original"<?php if (!empty($value['size']) and $value['size'] == 'original') {
                echo ' selected="selected"';
} ?>><?php e(t('original', 'filehandler')); ?></option>
            <?php foreach ($instances as $instance) : ?>
            <option value="<?php e($instance['name']); ?>"<?php if (!empty($value['size']) and $value['size'] == $instance['name']) {
                echo ' selected="selected"';
