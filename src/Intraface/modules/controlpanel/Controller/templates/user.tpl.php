...
<table class="vcard">
    ...
    <tr>
        ...
        <td><span class="email"><?php if (!empty($value['email'])) {
            e($value['email']);
} ?></span></td>
    </tr>
</table>
...
<table class="vcard">
    ...
    <tr>
        ...
        <td class="fn"><?php if (!empty($address_value['name'])) {
            e($address_value['name']);
} ?></td>
    </tr>
    <tr>
        <th><?php e(t('e-mail', 'address')); ?></th>
        <td><span class="email"><?php if (!empty($address_value['email'])) {
    ...
    <tr>
        ...
        <td class="street-address"><?php if (!empty($address_value['address'])) {
            e($address_value['address']);
} ?></td>
    </tr>
    <tr>
        <th><?php e(t('postal code and city', 'address')); ?></th>
        <td><span class="postal-code"><?php if (!empty($address_value['postcode'])) {
            e($address_value['postcode']);
} ?></span> <span class="locality"> <?php if (!empty($address_value['city'])) {
    e($address_value['city']);
} ?></span></td>
    </tr>
    <tr>
        <th><?php e(t('country', 'address')); ?></th>
        <td class="country"><?php if (!empty($address_value['country'])) {
    ...
    <tr>
        ...
        <td class="tel"><?php if (!empty($address_value['phone'])) {
            e($address_value['phone']);
} ?></td>
    </tr>
    <tr>
        <th><?php e(t('website', 'address')); ?></th>
        <td class="url"><?php if (!empty($address_value['website'])) {
