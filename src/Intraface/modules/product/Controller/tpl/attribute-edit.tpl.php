...
<fieldset>
    <legend><?php e(t('Attribute information')); ?></legend>
        <input type="hidden" name="id" value="<?php if (isset($attribute)) {
            e($attribute->getId());
} ?>" />
        <input type="hidden" name="group_id" value="<?php if (isset($group)) {
            e($group->getId());
} ?>" />
        <div class="formrow">
            <label for="name"><?php e(t('Name')); ?></label>
            <input type="text" name="name" id="name" value="<?php if (isset($attribute)) {
                e($attribute->getName());
} ?>" />
        </div>
    </fieldset>
