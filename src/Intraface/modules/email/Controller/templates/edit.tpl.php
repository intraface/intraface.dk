...
<form action="<?php e(url(null, array($context->subview()))); ?>" method="post">
    ...
    <fieldset>
        ...
        <div class="formrow">
            ...
            <input type="checkbox" name="bcc_to_user" id="bcc_to_user" value="1" <?php if (isset($value['bcc_to_user']) && intval($value['bcc_to_user']) == 1) {
                echo 'checked="checked"';
} ?> /> <?php echo $kernel->user->getAddress()->get('name').' &#60'.$kernel->user->getAddress()->get('email').'&#62'; ?>
        </div>
        <div class="formrow">
