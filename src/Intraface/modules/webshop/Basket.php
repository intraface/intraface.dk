...
class Basket
{
    ...
    /**
     * M�ske un�dvendig, da den efter �ndringer i klassen altid er konstant. Men fordi
     * det var lettere at bibeholde den, blev det s�dan.
     *
     * @var string
     */
    public $sql_extra; // bruges s� vi ikke beh�ver at tjekke om der skal skelnes p� session eller id
