...
<fieldset>
    ...
    <input type="text" name="quantity" id="quantity" value="<?php if (!empty($values['quantity'])) {
        e($values["quantity"]);
} ?>" />
    </div>
    ...
    <input type="text" name="dk_unit_purchase_price" id="dk_unit_purchase_price" value="<?php if (!empty($values['dk_unit_purchase_price'])) {
        e($values["dk_unit_purchase_price"]);
} ?>" />
    </div>
</fieldset>
<div>
