...
class Payment extends Intraface_Standard
{
    ...
    function update($input = "")
    {
        ...
        // Man har mulighed for at k�re $payment->update() bare for at f� den til at
        // s�tte invoice eller reminder til executed
        if (!is_array($input)) {
    ...
    */
    ...
    function readyForState()
    {
        ...
        if ($this->isStated()) {
            $this->error->set('Betalingen er allerede bogf�rt');
            return false;
        }
