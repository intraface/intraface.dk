 ...
 *       der var brug for den. Klasserne med IntranetAdmin er IKKE tilpasset �ndringerne
 *       i $kernel.
 *
 * @todo Hvorfor ligger disse funktioner ikke bare i intranet. Det er jo ikke s�dan,
