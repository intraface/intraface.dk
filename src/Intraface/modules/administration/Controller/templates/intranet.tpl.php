...
<?php endif; ?>
    ...
    <tr>
        <th><?php e(t('Name')); ?></th>
        <td class="fn"><?php if (isset($address['name'])) {
            e($address["name"]);
} ?></td>
    </tr>
    <tr>
        <th><?php e(t('Address')); ?></th>
        <td class="street-address"><?php if (isset($address['address'])) {
            e($address["address"]);
} ?></td>
    </tr>
    <tr>
        ...
        <td>
            <span class="postal-code"><?php if (isset($address['postcode'])) {
                e($address["postcode"]);
} ?></span>
            <span class="locality"><?php if (isset($address['city'])) {
                e($address["city"]);
} ?></span>
        </td>
    </tr>
    <tr>
        ...
        <td class="country"><?php if (isset($address['country'])) {
            e($address["country"]);
} ?></td>
    </tr>
    <tr>
        <th><?php e(t('CVR-number')); ?></th>
        <td><?php if (isset($address['cvr'])) {
            e($address["cvr"]);
} ?>
    ...
    <tr>
        <th><?php e(t('Email')); ?></th>
        <td class="email"><?php if (isset($address['email'])) {
            e($address["email"]);
} ?></td>
    </tr>
    <tr>
        <th><?php e(t('Website')); ?></th>
        <td class="url"><?php if (isset($address['website'])) {
            e($address["website"]);
} ?></td>
    </tr>
    <tr>
        <th><?php e(t('Phone')); ?></th>
        <td class="tel"><?php if (isset($address['phone'])) {
            e($address["phone"]);
} ?></td>
    </tr>
</table>
