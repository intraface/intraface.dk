    ...
    <fieldset>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <td>
                        <input tabindex="1" name="date" type="text" size="7" value="<?php if (!empty($values['date'])) {
                            e($values['date']);
}  ?>" />
                    </td>
                    <td>
                        <input tabindex="2" type="text" name="text" id="text" value="<?php if (!empty($values['text'])) {
                            e($values['text']);
} ?>" />
                    </td>
                    <td>
                        <select name="account" tabindex="3">
                            ...
                            foreach ($account->getList() as $a) :
                                ...
                                if (!empty($values['account_number']) and $values['account_number'] == $a['number']) {
                    ...
                    <td>
                        <input tabindex="4" name="debet" id="amount" type="text" size="8"  value="<?php if (!empty($values['debet'])) {
                            e(amountToForm($values['debet']));
} ?>" />
                    </td>

                    <td>
                        <input tabindex="5" name="credit" id="amount" type="text" size="8"  value="<?php if (!empty($values['credit'])) {
                            e(amountToForm($values['credit']));
} ?>" />
                    </td>
                    <td>
