...
<?php if (isset($modulepackagemanager)) {
    echo $modulepackagemanager->error->view();
} ?>
...
<table>
    ...
    <tr>
        <th><?php e(t('Name')); ?></th>
        <td><?php if (isset($address_value["name"])) {
    ...
    <tr>
        ...
        <td><?php if (isset($address_value["address"])) {
    ...
    <tr>
        ...
        <td><?php if (isset($address_value["postcode"])) {
            e($address_value["postcode"]);
} ?> <?php if (isset($address_value["city"])) {
    e($address_value["city"]);
} ?></td>
    </tr>
    <tr>
        <th><?php e(t('Country')); ?></th>
        <td><?php if (isset($address_value["country"])) {
            e($address_value["country"]);
} ?></td>
    </tr>
    <tr>
        <th><?php e(t('CVR-number')); ?></th>
        <td><?php if (isset($address_value["cvr"])) {
            e($address_value["cvr"]);
} ?></td>
    </tr>
    <tr>
        <th><?php e(t('Email')); ?></th>
        <td><?php if (isset($address_value["email"])) {
    ...
    <tr>
        ...
        <td><?php if (isset($address_value["website"])) {
    ...
    <tr>
        ...
        <td><?php if (isset($address_value["phone"])) {
...
<fieldset>
    ...
    <?php foreach ($modules as $module) : ?>
        <div style="float: left; width: 210px; ">
            <input type="checkbox" name="module[]" id="module_<?php e($module["name"]); ?>" value="<?php e($module["name"]); ?>"<?php if ($context->getIntranet()->hasModuleAccess(intval($module["id"]))) {
