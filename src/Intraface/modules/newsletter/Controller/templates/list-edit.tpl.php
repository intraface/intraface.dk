...
-->
    ...
    <div style="clear: both;">
        <p>Enten kan du vælge følgende link: <strong><?php e('http://' . $context->getKernel()->setting->get('intranet', 'contact.login_url') . '/' .$context->getKernel()->intranet->get('identifier') . '/login'); ?></strong> eller du kan skrive dit eget:</p>
