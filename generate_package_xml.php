...
$pfm->addPackageDepWithChannel('required', 'Ilib_Variable', 'public.intraface.dk', '0.1.0');
...
$pfm->addPackageDepWithChannel('required', 'IntrafacePublic_Shop_Client_XMLRPC', 'public.intraface.dk', '0.3.0');
