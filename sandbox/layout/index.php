...
class RestrictedController extends k_Component {
  ...
  function renderHtml() {
    return
      ...
      sprintf("<p><a href='%s'>modules</a></p>", htmlspecialchars($this->url('modulehandler')));
  }
}
...
class ModuleHandler extends k_Component
{
  ...
  function renderHtml()
  {
      return sprintf("<h1>Modules</h1><p><a href='%s'>the dojo</a></p>", htmlspecialchars($this->url('dojo')));

  }
}

class MyModule extends k_Component
{
  function dispatch() {
