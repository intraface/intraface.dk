...
<div id="keywords" class="box <?php if (!empty($_GET['from']) AND $_GET['from'] == 'keywords') echo ' fade'; ?>">
 <h2><?php echo safeToHtml($translation->get('keywords', 'keyword')); ?></h2>
    ...
    <ul class="button"><li><a href="/shared/keyword/connect.php?contact_id=<?php echo $contact->get('id'); ?>"><?php echo safeToHtml($translation->get('add keywords', 'keyword')); ?></a></li></ul>
    <?php } ?>
	<?php
