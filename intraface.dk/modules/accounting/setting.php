...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
	...
	<fieldset>
		...
		<div class="formrow">
			<label for="result_account_id_start">Resultat - første konto</label>
		...
		<div class="formrow">
			<label for="result_account_id_end">Resultat - sidste konto</label>
		...
		<div class="formrow">
			<label for="balance_account_id_start">Balance - første konto</label>
		...
		<div class="formrow">
			<label for="balance_account_id_end">Balance - sidste konto</label>
