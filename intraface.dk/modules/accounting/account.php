...
$posts[0]['text'] = '<strong>Primosaldo</strong>';
...
<h1><?php echo $account->get('number'); ?>: <?php echo $account->get('name'); ?></h1>

<ul class="options">
	<li><a href="account_edit.php?id=<?php echo $account->get('id'); ?>">Ret</a></li>
	<li><a href="accounts.php?from_account_id=<?php echo $account->get('id'); ?>">Luk</a></li>
</ul>
...
<table>
	<tr>
		...
		<td rowspan="2"><?php echo $account->get('comment'); ?></td>
	</tr>
	<tr>
		<th>Type</th>
		<td><?php echo $account->get('type'); ?></td>	</tr>
	<tr>
		<th>Moms</th>
		<td><?php echo $account->get('vat'); ?></td>
	</tr>
</table>
-->
	...
	<table>
		...
		<tbody>
			...
			<tr>
				...
				<td class="amount"><?php echo amountToOutput($saldo); ?></td>
			</tr>
			<?php } ?>
		</tbody>
	</table>
