	...
	<fieldset>
		...
		<table>
			...
			<tbody>
				<tr>
					<td>
						<input tabindex="1" name="date" type="text" size="7" value="<?php echo safeToHtml($values['date']);  ?>" />
					</td>
					<td>
						<input tabindex="2" type="text" name="text" id="text" value="<?php echo safeToHtml($values['text']); ?>" />
					</td>
					<td>
						<select name="account" tabindex="3">
							...
							<?php
								foreach($account->getList() AS $a):
									...
									if ($values['account_number'] == $a['number']) echo ' selected="selected"';
									echo '>'.$a['name'].'</option>';
								endforeach;
							?>
						</select>
					...
					<td>
						<input tabindex="4" name="debet" id="amount" type="text" size="8"  value="<?php echo amountToForm($values['debet']); ?>" />
					</td>

					<td>
						<input tabindex="5" name="credit" id="amount" type="text" size="8"  value="<?php echo amountToForm($values['credit']); ?>" />
					</td>
					<td>
