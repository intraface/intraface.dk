...
$page->start($translation->get($page_types_plural[$type]));

?>

<h1><?php e($translation->get($page_types_plural[$type])); ?> <?php e($translation->get('on', 'common')); ?> "<?php e($cmssite->get('name')); ?>"</h1>
...
<ul class="options">
    <li><a class="new" href="page_edit.php?type=<?php e($type); ?>&amp;site_id=<?php e($cmssite->get('id')); ?>"><?php e($translation->get('create '.$type)); ?></a></li>
    <li><a  href="site.php?id=<?php e($cmssite->get('id')); ?>"><?php e($translation->get('go to site overview')); ?></a></li>
</ul>
...
<?php if ($type == 'page'): ?>
    ...
    if (!is_array($pages) OR count($pages) == 0): ?>
        <p><?php e($translation->get('no pages found')); ?></p>
    <?php else: ?>
        <table>
                ...
                <tr>
                    ...
                    <td>
                        <?php if ($p['status'] == 'published'): // hack siden kan kun vises, hvis den er udgivet. Der bør laves et eller andet, så det er muligt anyways - fx en hemmelig kode på siden ?>
                            <a href="<?php e($p['url']); ?>" target="_blank"><?php e($translation->get('show page')); ?></a>
                        <?php endif; ?>
                    </td>
                    <td class="options">
                        <a class="moveup" href="<?php e($_SERVER['PHP_SELF']); ?>?id=<?php e($cmssite->get("id")); ?>&amp;moveup=<?php e($p['id']); ?>&amp;type=<?php e($type); ?>"><?php e($translation->get('up', 'common')); ?></a>
                        <a class="moveup" href="<?php e($_SERVER['PHP_SELF']); ?>?id=<?php e($cmssite->get("id")); ?>&amp;movedown=<?php e($p['id']); ?>&amp;type=<?php e($type); ?>"><?php e($translation->get('down', 'common')); ?></a>
                        <a class="edit" href="page_edit.php?id=<?php e($p['id']); ?>"><?php e($translation->get('edit settings', 'common')); ?></a>
                        <a class="delete" href="<?php e($_SERVER['PHP_SELF']); ?>?delete=<?php e($p['id']); ?>&amp;type=<?php e($type); ?>"><?php e($translation->get('delete', 'common')); ?></a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
...
<?php elseif ($type == 'article'): ?>
    ...
    if (!is_array($articles) OR count($articles) == 0): ?>
        <p><?php e($translation->get('no articles found')); ?></p>
    <?php else: ?>
        <table>
            ...
            <?php foreach ($articles AS $p):?>
                <tr>
                    ...
                    <td>
                    <?php if ($p['status'] == 'published'): // hack siden kan kun vises, hvis den er udgivet. Der bør laves et eller andet, så det er muligt anyways - fx en hemmelig kode på siden ?>
                        <a href="<?php e($p['url']); ?>" target="_blank"><?php e($translation->get('show page', 'common')); ?></a>
                    <?php endif; ?>
                    </td>
                    <td class="options"><a class="edit" href="page_edit.php?id=<?php e($p['id']); ?>"><?php e($translation->get('edit settings', 'common')); ?></a>
                    <a class="delete" href="<?php e($_SERVER['PHP_SELF']); ?>?delete=<?php e($p['id']); ?>"><?php e($translation->get('delete', 'common')); ?></a></td>
                </tr>
            <?php endforeach; ?>
        </table>
    <?php endif; ?>
<?php elseif ($type == 'news'): ?>
    ...
    if (!is_array($news) OR count($news) == 0): ?>
        <p><?php e($translation->get('no news found')); ?></p>
    <?php else: ?>
        <table>
            ...
            <?php foreach ($news AS $p):?>
                <tr>
                    ...
                    <td class="options"><a class="edit" href="page_edit.php?id=<?php e($p['id']); ?>"><?php e($translation->get('edit settings', 'common')); ?></a>
                        <a class="delete" href="<?php e($_SERVER['PHP_SELF']); ?>?delete=<?php e($p['id']); ?>"><?php e($translation->get('delete', 'common')); ?></a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
