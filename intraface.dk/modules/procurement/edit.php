...
<fieldset>
    ...
    <div class="formrow">
        ...
        <input type="text" name="dk_price_items" id="dk_price_items" value="<?php if (isset($values['dk_price_items'])) print($values["dk_price_items"]); ?>" size="10" /> Kr. (eks. moms)
    </div>

    <div class="formrow">
        <label for="dk_price_shipment_etc">Pris for forsendelse, gebyr osv.</label>
        <input type="text" name="dk_price_shipment_etc" id="dk_price_shipment_etc" value="<?php  if (isset($values['dk_price_shipment_etc'])) echo safeToForm($values["dk_price_shipment_etc"]); ?>" size="10" /> Kr. (eks. evt. moms)
    </div>

    <div class="formrow">
        <label for="dk_vat">Moms</label>
        <input type="text" name="dk_vat" id="vat" value="<?php  if (isset($values['dk_vat'])) echo safeToHtml($values["dk_vat"]); ?>" size="10" /> Kr.
    </div>
