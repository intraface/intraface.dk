...
<?php if(!empty($deleted)): ?>
        <p class="message"><?php e(t('An attribute group has been deleted')); ?>. <input type="hidden" name="deleted" value="<?php echo base64_encode(serialize($deleted)); ?>" /> <input name="undelete" type="submit" value="<?php e(t('regret', 'common')); ?>" /></p>
<?php endif; ?>
</form>
        ...
        <tbody>
            <?php foreach($groups AS $group): ?>
                <tr>
                    ...
                    <td><a href="attribute_group.php?id=<?php echo $group->getId(); ?>"><?php echo safeToHtml($group->getName()); ?></a></td>
                    <td class="options"><a class="edit" href="attribute_group_edit.php?id=<?php echo intval($group->getId()); ?>"><?php e(t('edit', 'common')); ?></a></td>
                </tr>
             <?php endforeach; ?>
        </tbody>
    </table>
