                ...
                <tr>
                    <td>
                        <?php if($multiple && $quantity): ?>
                            <input id="<?php e($variation->getId()); ?>" type="text" name="selected[<?php echo intval($variation->getId()); ?>]" value="<?php echo '0' ?>" size="2" />
                        <?php elseif($multiple && !$quantity): ?>
                            <input id="<?php e($variation->getId()); ?>" type="checkbox" name="selected[<?php echo intval($variation->getId()); ?>]" value="1" />
                        <?php elseif(!$multiple): ?>
                            <input id="<?php e($variation->getId()); ?>" type="radio" name="selected" value="<?php echo intval($variation->getId()); ?>" />
                        <?php endif; ?>
                    </td>
